...
- [General Architecture Topics](#general-architecture-topics)
  ...
  - [Podcasts](#podcasts)
  - [Articles](#articles)
  - [Enterprise Architecture, Organization Development](#enterprise-architecture-organization-development)
...
- [Domain Driven Design](#domain-driven-design)
  - [Tools](#tools)
  - [Trainings on DDD](#trainings-on-ddd)
  - [Audio](#audio)
  - [Web-Links on DDD](#web-links-on-ddd)
  - [Books on DDD](#books-on-ddd)
- [Architecture Evaluation](#architecture-evaluation)
  - [Trainings on Architecture Evaluation](#trainings-on-architecture-evaluation)
  - [Web Links on Architecture Evaluation](#web-links-on-architecture-evaluation)
  - [Books](#books)
- [Microservice and Self Contained Systems Architecture](#microservice-and-self-contained-systems-architecture)
  - [Trainings on Microservice and SCS Architecture](#trainings-on-microservice-and-scs-architecture)
  - [Web Links on Microservice and SCS Architecture](#web-links-on-microservice-and-scs-architecture)
